...
def compensate_P(adc_P):
    ...
    v1 = (digP[8] * ((pressure / 8.0)**2 / 8192.0)) / 4096
...
def setup():
    ...
    mode, t_sb, filt, spi3w_en = 3, 5, 0, 0
...
ax.set_title("Realtime BME280 Pressure")
